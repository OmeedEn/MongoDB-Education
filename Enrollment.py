...
def add_letter_grade(db):
    ...
    while not unique_enrollment:
        ...
        if unique_enrollment:
            enrollment_type = {'minSatisfactory': grade}
            enrollment = {
...
def create_enrollment(db):
    ...
    enrollment_validator = {
        'bsonType': "object",
        'description': 'the enrollment of the students',
        'required': ['studentId', 'sectionId', 'departmentAbbreviation', 'courseNumber', 'sectionYear', 'semester',
                     'enrollmentType'],
        ...
        'properties': {
            ...
            'courseNumber': {
                'bsonType': 'number',
                'description': 'The courseNumber of the section that student is enrolling in.'
            },
            'sectionYear': {
                'bsonType': 'number',
